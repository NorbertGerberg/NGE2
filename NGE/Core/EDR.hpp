...
namespace EDR
{
	...
	strg				WriteBinaryToString(strg& content);
	strg				ReadBinaryToString(strg& content);
	...
	void					AddBinaryToArchive(Archive* z, const char* filename, const char* content, uint64 size);
