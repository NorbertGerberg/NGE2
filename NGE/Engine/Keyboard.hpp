...
#define NGE_KEYBOARD_KEYCALLBACK GLFWkeyfun
...
#if NGE_INPUT_KEYBOARD_LAYOUT_GERMAN	// German keyboard layout
constexpr auto NGE_INPUT_KEY_Y = 90;
constexpr auto NGE_INPUT_KEY_Z = 89;
#else
constexpr auto NGE_INPUT_KEY_Y = 89;
constexpr auto NGE_INPUT_KEY_Z = 90;
#endif
...
//! Keyboard input
//! \ingroup Engine
//! Use macro 'NGE_INPUT_KEYBOARD_LAYOUT_GERMAN' before including this file to switch the z and y key for german keyboard layout!
...
public:
	...
	const bool GetAnyKeyDown();
	const bool GetAnyKeyPressed();

	//Text input
	void SetCharCallback(NGE_KEYBOARD_CHARCALLBACK callback);
	void SetKeyCallback(NGE_KEYBOARD_KEYCALLBACK callback);
